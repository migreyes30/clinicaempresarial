    ...
    <td width="400" valign="top">
		...
		<table width="100%" border="0">
		  <tr>
			...
			<td align="left"><input type="text" name="" size="37" value="Paviemntación de Predi" disabled="disabled" /></td>
		  </tr>
		  <tr>
		  ...
		  <tr>
			...
			<td align="left"><input type="text" maxlength="8" size="8" name="" value="14/05/2009" disabled="disabled" /></td>
		  </tr>
		</table>
		...
		<table width="100%" border="0">
		  <tr>
			...
			<td align="left">
				...
				<select name="" disabled="disabled">
					<option value="" di>Consap/Pailas/RG</option>
		  ...
		  <tr>
			...
			<td align="left"><input type="text" name="" size="37" value="Juan Vicenteño" disabled="disabled" /></td>
		  </tr>
		  <tr>
			<td>&nbsp;</td>
			<td>&nbsp;</td>			
...
<table width="100%" border="0" cellpadding="2">
  ...
  <tr>
    ...
    <td align="center" bgcolor="#FFFFDD"><input type="checkbox" disabled="disabled" checked="checked" /></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td bgcolor="#F5FAFF">Diagramas eléctricos</td>
    <td align="center" bgcolor="#F5FAFF"><input type="checkbox" disabled="disabled" /></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="center" bgcolor="#FFFFDD"><input type="checkbox" disabled="disabled" /></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="center" bgcolor="#F5FAFF"><input type="checkbox" disabled="disabled" checked="checked"  /></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td bgcolor="#F5FAFF" align="center"><input type="checkbox" disabled="disabled" checked="checked"  /></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
</table>
...
<table width="100%" border="0" cellpadding="8" cellspacing="0" style='border-width: 1px; border-spacing: ; border-style: ridge; border-color:#EEEEEE; border-collapse: separate; background-color: white;'>
  ...
  <tr>
    ...
    <td align="left">
	<textarea name="" cols="80" rows="8" readonly="readonly">
	
dasf jshdjf sjkldfj kljgk sdghj hsjdhjkshdjv jsdjn fjdshjkhjkgkjsdhgj hjskdhg jkshd haskdj	h jksdh kjshdg
...
dasf jshdjf sjkldfj kljgk sdghj hsjdhjkshdjv jsdjn fjdshjkhjkgkjsdhgj hjskdhg jkshd haskdj	h jksdh kjshdg
  ...
  <tr> 
 <td align='right' valign='top' >Anotaciones N0</td> 
 <td align='left'> 
 <textarea name='' cols='80' rows='5'  readonly='readonly'></textarea> 
 </td> 
 </tr> 

 <tr> 
 <td align='right' valign='top' >Anotaciones N1</td> 
 <td align='left'> 
 <textarea name='' cols='80' rows='5'  readonly='readonly'></textarea> 
 </td> 
 </tr> 
 ...
 <tr> 
 <td align='right' valign='top' >Anotaciones N2</td> 
 <td align='left'> 
 <textarea name='' cols='80' rows='5' readonly='readonly'></textarea> 
 </td> 
 </tr> 
