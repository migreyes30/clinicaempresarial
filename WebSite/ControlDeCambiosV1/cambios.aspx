                                ...
                                <table cellpadding="4" style="width:100%;">
                                    <tr>
                                        ...
                                        <td class="style15" align="left" bgcolor="#F9F9F7">
                                            <asp:Label ID="Label10" runat="server" Text="Fecha Recepción" 
                                    ...
                                    <tr>
                                        ...
                                        <td class="style15" align="left" bgcolor="#F9F9F7">
                                            <asp:Label ID="Label11" runat="server" Text="Fecha Aprobación" 
                                                Font-Names="Arial" Font-Size="Small"></asp:Label>
                                        </td>
                                        <td align="left">
                                    ...
                                    <tr>
                                        ...
                                        <td class="style2" align="left">
                                            <asp:DropDownList ID="DropDownList2" runat="server">
                                                ...
                                                <asp:ListItem>Nave de Empaque</asp:ListItem>
                                                <asp:ListItem>Making</asp:ListItem>
                                                <asp:ListItem>Mezanin</asp:ListItem>
