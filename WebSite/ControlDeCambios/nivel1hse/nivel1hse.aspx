...
INNER JOIN NIVEL1_HSE ON CAMBIO.CAMBIO_ID = NIVEL1_HSE.CAMBIO_ID INNER JOIN DEPARTAMENTO ON 
DEPARTAMENTO.DEPTO_ID = AREA.DEPTO_ID 
where CAMBIO.CAMBIO_ID = NIVEL1_HSE.CAMBIO_ID and AREA.AREA_ID = NIVEL1_HSE.AREA_ID and AREA.DEPTO_ID = DEPARTAMENTO.DEPTO_ID and NIVEL1_HSE.STATUS = 'Pendiente';">
                    </asp:SqlDataSource>
                    <br />
