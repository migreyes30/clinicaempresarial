...
public class ManejadorCambio
{
    ...
    public void rechazarN1HSE(String comentarios, int cambioID)
    {
        ...
        insertando = new SqlCommand("UPDATE NIVEL1_QA set STATUS = 'Rechazado', FECHA_APROBACION = CURRENT_TIMESTAMP, COMENTARIOS = 'RECHAZADO POR HSE' WHERE CAMBIO_ID = '" + cambioID + "'", thisConnection);
        insertando.ExecuteNonQuery();
    ...
    public void rechazarN1QA(String comentarios, int cambioID)
    {
        ...
        insertando = new SqlCommand("UPDATE NIVEL1_HSE set STATUS = 'Rechazado', FECHA_APROBACION = CURRENT_TIMESTAMP, COMENTARIOS = 'RECHAZADO POR QA' WHERE CAMBIO_ID = '" + cambioID + "'", thisConnection);
        insertando.ExecuteNonQuery();
