            ...
            <tr>
                <td colspan="6" align="center" 
                    ...
                    <asp:SqlDataSource ID="NivelCeroDataSource" runat="server" 
                        ...
                        ProviderName="<%$ ConnectionStrings:ControlCambiosConnectionString1.ProviderName %>" SelectCommand="SELECT CAMBIO.CAMBIO_ID, AREA.NOMBRE_AREA, CAMBIO.NOMBRE_CAMBIO, CAMBIO.TIPO_CAMBIO, CAMBIO.FECHA_RECEPCION FROM CAMBIO INNER JOIN AREA ON CAMBIO.AREA_ID = AREA.AREA_ID INNER JOIN NIVEL0 ON CAMBIO.CAMBIO_ID = NIVEL0.CAMBIO_ID WHERE (CAMBIO.AREA_ID IN (SELECT AREA_1.AREA_ID FROM USUARIO INNER JOIN DEPARTAMENTO ON USUARIO.USUARIO_ID = DEPARTAMENTO.REPONSABLE_ID INNER JOIN AREA AS AREA_1 ON DEPARTAMENTO.DEPTO_ID = AREA_1.DEPTO_ID WHERE (USUARIO.NOMBRE_USUARIO = @user ))) AND (NIVEL0.FECHA_APROBACION IS NULL)" 
