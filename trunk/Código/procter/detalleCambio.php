    ...
    <td width="400" valign="top">
		...
		<table width="100%" border="0">
		  <tr>
			...
			<td align="left"><input type="text" name="" size="37" value="Paviemntación de Predi" /></td>
		  </tr>
		  <tr>
		  ...
		  <tr>
			...
			<td align="left"><input type="text" maxlength="8" size="8" name="" value="14/05/2009" /></td>
		  </tr>
		</table>
    ...
    <td valign="top">
		...
		<table width="100%" border="0">
		  ...
		  <tr>
			...
			<td align="left"><input type="text" name="" size="37" value="Juan Manuel Vicenteño" /></td>
		  </tr>
		  <tr>
			<td>&nbsp;</td>
			<td>&nbsp;</td>			
...
<table width="100%" border="0" cellpadding="2">
  ...
  <tr>
    ...
    <td align="center" bgcolor="#FFFFDD"><input type="checkbox" checked="checked"/></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td bgcolor="#F5FAFF">SOP's</td>
    <td align="center" bgcolor="#F5FAFF"><input type="checkbox" checked="checked"/></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
...
<table width="100%" border="0" cellpadding="8" cellspacing="0" style='border-width: 1px; border-spacing: ; border-style: ridge; border-color:#EEEEEE; border-collapse: separate; background-color: white;'>
  ...
  <tr>
    ...
    <td align="left">
	<textarea name="" cols="80" rows="8">
	f jsdkhgj hdsjg hjsdg ñjsdhg jsdgsdg
	sdg sjdgh ñjshdgjhasjdgh jshdgh sñdjgh shdg hjsdhgjhsdjhjghsjhisdhggks ghsjdh jhsdjgsd
	
	askjgd jsjdgh jshgj añsjdghñajsdgh ñaksjdgh ñjshdgñ jshdgj hñsjkgh jshgjhsgkjsdh
	</textarea></td>
  </tr>
  <tr>
...
<table width="100%" border="0">
  <tr>
    ...
    <td width="100"><input type="submit" name="" value="Modificar" style="background:#0A479C; 
					color:#FFFFFF; border:none; cursor:pointer; font-weight:600;" /></td>	
  </tr>
</table>
