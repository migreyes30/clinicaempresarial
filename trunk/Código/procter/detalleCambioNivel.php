...
echo"  <tr>";
echo"      <td align='right' valign='top' >Anotaciones N0</td>";
echo"      <td align='left'>";
echo"  	<textarea name='' cols='80' rows='5'></textarea>";
echo"  	</td>";
echo"    </tr>";
...
echo"      <td align='right' valign='top' >Anotaciones N0</td>";
echo"      <td align='left'>";
echo"  	<textarea name='' cols='80' rows='5'  readonly='readonly'></textarea>";
echo"  	</td>";
echo"    </tr>";


echo"  <tr>";
echo"      <td align='right' valign='top' >Anotaciones N1</td>";
echo"      <td align='left'>";
echo"  	<textarea name='' cols='80' rows='5'></textarea>";
echo"  	</td>";
echo"    </tr>";
...
echo"  <tr>";
echo"      <td align='right' valign='top' >Anotaciones N2</td>";
echo"      <td align='left'>";
echo"  	<textarea name='' cols='80' rows='5'></textarea>";
echo"  	</td>";
echo"    </tr>";
...
<table width="100%" border="0">
  <tr>
    <td width="600"></td>
    <td width="100"><input type="submit" name="" value="Aprobar" style="background:#0A479C; 
					color:#FFFFFF; border:none; cursor:pointer; font-weight:600;" /></td>
    <td width="100"><input type="submit" name="" value="Rechazar" style="background:#0A479C; 
					color:#FFFFFF; border:none; cursor:pointer; font-weight:600;" /></td>	
  </tr>
</table>
