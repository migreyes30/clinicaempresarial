                                    ...
                                    <tr>
                                        <td class="style14" align="left" bgcolor="#F9F9F7">
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                                                ...
                                                SelectCommand="select NOMBRE_CAMBIO, TIPO_CAMBIO, DEPARTAMENTO.NOMBRE_DEPTO, AREA.NOMBRE_AREA, NIVEL1_QA.FECHA_ASIGNACION  
from DEPARTAMENTO, CAMBIO, NIVEL1_QA, AREA
 where CAMBIO.CAMBIO_ID = ? and CAMBIO.CAMBIO_ID = NIVEL1_QA.CAMBIO_ID and AREA.AREA_ID = CAMBIO.AREA_ID and  AREA.DEPTO_ID = DEPARTAMENTO.DEPTO_ID;
 ">
                                                <SelectParameters>
